...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/home/pirai/.rvm/rubies/ruby-1.9.2-p180")
  ...
  CONFIG["configure_args"] = " '--prefix=/home/pirai/.rvm/rubies/ruby-1.9.2-p180' '--enable-shared' '--disable-install-doc'"
